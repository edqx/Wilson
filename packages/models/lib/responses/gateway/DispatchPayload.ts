...
export interface GuildIntegrationsUpdateDispatchPayload
    extends BaseDispatchPayload {
...
export interface MessageReactionRemoveDispatchPayload
    extends BaseDispatchPayload {
    d: MessageReactionRemoveData;
    t: GatewayEvent.MessageReactionRemove;
}

export interface MessageReactionRemoveAllDispatchPayload
    extends BaseDispatchPayload {
    d: MessageReactionRemoveAllData;
    t: GatewayEvent.MessageReactionRemoveAll;
}

export interface MessageReactionRemoveEmojiDispatchPayload
    extends BaseDispatchPayload {
